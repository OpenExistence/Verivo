    ...
    <div class="auth-container">
      <div class="auth-card">
        <div class="auth-header">
          ...
          <p>Rejoignez Verivo et participatez aux votes</p>
        </div>
        ...
        <form @submit.prevent="handleRegister" class="auth-form">
          ...
          <div class="form-group">
            <label for="wallet">Adresse wallet (optionnel)</label>
            <input 
              id="wallet" 
              v-model="wallet" 
              type="text" 
          ...
          <div v-if="success" class="success-message">Compte créé! Redirect...</div>
